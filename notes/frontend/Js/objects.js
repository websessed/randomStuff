...
Accesing Properties
    ...
    /*Dot Notation*/
    console.log(person.name); //userName - Note: person.user-name wouldn't work 
                             //(interpreted as user.user - name), use brackets instead ['user-name]
...
Freezing Objects 
*/
const frozen = Object.freeze({ systemTheme: 'dark' });
fronzen.systemTheme = 'light'; //❌ fails - frozen objects are immutable 
